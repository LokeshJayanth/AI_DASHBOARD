...
def create_dataset(name, description, file_path, file_type, file_size, user_id=1):
    """Create a new dataset record"""
    query = """
        INSERT INTO datasets (name, description, file_path, file_type, file_size, user_id, status)
        VALUES (%s, %s, %s, %s, %s, %s, 'completed')
    """
    params = (name, description, file_path, file_type, file_size, user_id)
